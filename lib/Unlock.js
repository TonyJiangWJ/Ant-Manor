 ...
 * @Last Modified time: 2020-04-23 14:20:45
 * @Description: 
 */
let _config = typeof config === 'undefined' ? require('../config.js').config : config
let automator = require('./Automator.js').automator
let FileUtils = require('./FileUtils.js').FileUtils
...
let _commonFunctions = typeof commonFunctions === 'undefined' ? require('../lib/CommonFunction.js').commonFunctions : commonFunctions
