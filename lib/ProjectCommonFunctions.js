...
let VILIAGE_SPEED_UP = "viliageSpeedUp"
/**
 * 项目新增的方法写在此处
 */
const ProjectCommonFunction = function () {
  ...
  this.keyList = [SLEEP_TIME, VILIAGE_SPEED_UP]
  ...
  this.checkSpeedUpCollected = function () {
    let speedUpInfo = this.getTodaysRuntimeStorage(VILIAGE_SPEED_UP)
    return speedUpInfo.collected
  }
  ...
  this.setSpeedUpCollected = function () {
    this.updateRuntimeStorage(VILIAGE_SPEED_UP, { collected: true })
  }
}
...
ProjectCommonFunction.prototype.initStorageFactory = function () {
  ...
  storageFactory.initFactoryByKey(VILIAGE_SPEED_UP, {
    collected: false
  })
}
